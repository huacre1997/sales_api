...
- JWT encrypted with public/private key using HS256 algorithm.
...
* **MySQL Database:** Transactional database, where in addition to products, it can manage purchase orders, sales, delivery, customers, suppliers, collections, among other information entities.
...
DB_MYSQL_USER='admin'
DB_MYSQL_PASS='Setiembref2%'
DB_MYSQL_PORT=3306
DB_MYSQL_DB='sales_api'
```
...
```
<a name="endpointProductDesactive"></a>
### Endpoint: Product Update
```
PUT /products/1/desactivate/
```
This endpoint is used to disable the product.
...
<a name="endpointProductRestore"></a>
### Endpoint: Product Update
```
PUT /products/2/restore/
```
This endpoint is used to restore the product.
...
<a name="endpointProductUpdate"></a>
### Endpoint: Product Update
```
PATH /products/6/
```
This endpoint is used to update the product.
...
GET /order/
```
This endpoint is used to return the order.
